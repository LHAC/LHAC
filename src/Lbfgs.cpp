...
//        _buff = new double[l];
//        /* permuting buff */
//        cblas_dgemv(CblasColMajor, CblasNoTrans, (int)l, (int)l, 1.0, permut_mx, (int)l, buff, 1, 0.0, _buff, 1);
//        
//        write2mat("permut_mx.mat", "permut_mx", permut_mx, l, l);
//        write2mat("buff_permut.mat", "buff_permut", _buff, cblas_M, 1);
//        
//        delete [] _buff;
//    }
//    
...
//    if (Sm->cols >= l) {
//        /* permuting buff */
//        cblas_dgemv(CblasColMajor, CblasNoTrans, (int)l, (int)l, 1.0, permut_mx, (int)l, buff, 1, 0.0, buff, 1);
//        
//        memset(permut_mx, 0, l*l*sizeof(double));
//    }
//    
